...
import com.zzti.hadoop_work.SortData;
import com.zzti.hadoop_work.SortMapper;
import com.zzti.hadoop_work.RecommendScoreMapper;
import com.zzti.hadoop_work.RecommendScoreReducer;
import com.zzti.hadoop_work.TransferUserScoreMapper;
...
public class Recommend {
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, URISyntaxException {
        ...
        JobInitModel userScoreMatrixJob = new JobInitModel(new String[]{userScoreMatrixInpath}, userScoreMatrixOutpath
                , conf
                , null
                , "CalcUserScoreMatrix", Recommend.class
        ...
        JobInitModel itermOccurrenceMatrixJob = new JobInitModel(new String[]{userScoreMatrixOutpath}, itermOccurrenceOutpath
                , conf
                , null
                , "CalcItermOccurrenceMatrix", Recommend.class
        ...
        if (args[0].equals("0")) {
            ...
            JobInitModel recommendJob = new JobInitModel(new String[]{userScoreMatrixOutpath}
                    , recommendOutpath, conf, job
                    , "recommend", Recommend.class
                    , null, RecommendMapper.class, Text.class, DoubleWritable.class
                    , null
            ...
            JobInitModel sortJob = new JobInitModel(new String[]{recommendOutpath}
                    , sortOutpath, conf
                    , null
                    , "sortRecommend", Recommend.class
                    , null, SortMapper.class, SortData.class, NullWritable.class
                    , null
                    , null
                    , null
                    , null
            ...
            JobInitModel transferUserScoreJob = new JobInitModel(new String[]{userScoreMatrixOutpath}, transferUserScoreOutpath
                    , conf
                    , null
                    , "TransferUserScore", Recommend.class
